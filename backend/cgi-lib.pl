...
# rotina que retorna o dia de ontem
($dia_ontem, $mes_ontem, $ano_ontem) = &some_days_ago();
sub some_days_ago {
    my $days = 1; # número de dia atrás
    my ($sec,$min,$hour,$mday,$mon,$year,$wday,$yday,$isdst) = localtime(time() - (3600 * 24 * $days));
