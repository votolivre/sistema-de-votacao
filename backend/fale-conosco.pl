...
$ativo_contato = " class=\"ativo\"";
$ativo_faleconosco = " class=\"ativo\"";
...
<ul><!-- geral -->
          ...
          <li class=\"nav\"><a href=\"#\"><h1>Na rede</h1></a>
            ...
            <img src=\"https://www.votolivre.org/votolivre/novosite/imagens/menu-spacer.gif\" width=\"20\" height=\"33\" />
          <li class=\"nav\"><a href=\"#\"><h1$ativo_faleconosco>Contato</h1></a>
            	<ul>
                <li><a href=\"https://www.votolivre.org/fale-conosco.html\"><h2$ativo_faleconosco>Fale Conosco</h2></a></li>
...
<div id="coluna-internas">
        	...
        	<a name="1"><h1>Contato</h1></a>
            <p>Voc&ecirc; pode entrar em contato conosco atrav&eacute;s do formul&aacute;rio abaixo.
            </p>
          	
            <form id="form_quatro" action="https://www.votolivre.org/cgi-local/votolivre/novosite/validacontato.pl" method="post">
            <p class="contato">Nome:</p>
			<input type="text" name="nome" id="form_nome" class="form_contato" value=""/>
            
            <p class="contato">Cidade:</p>
			<input type="text" name="cidade" id="form_cidade" class="form_contato" value="" />
            
            <p class="contato">Email:</p>
			<input type="text" name="email" id="form_email" class="form_contato" value="" />
            
            <p class="contato">Email novamente:</p>
			<input type="text" name="email2" id="form_email2" class="form_contato" value="" />
            
            <p class="contato">Assunto:</p>
			<input type="text" name="assunto" id="form_assunto" class="form_contato" value="" />
            
            <p class="contato">Mensagem:</p>
			<textarea name="mensagem" id="form_mensagem" class="form_contato2" value=""></textarea>


            
            <input type="submit" class="bt_contato" value=""  />

            <div style="float:left">
              <div id="search_indicator"><img src="https://www.votolivre.org/votolivre/img/loader1.gif" alt="carregando" /></div>
